...
Indicates whether a system, device or control loop is in a heating mode
...
## Child interfaces
* [Occupied_Heating_Mode_Status](../Occupied-/Occupied_Heating_Mode_Status.md)
* [Unoccupied_Heating_Mode_Status](../Unoccupied-/Unoccupied_Heating_Mode_Status.md)
